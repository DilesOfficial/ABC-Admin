                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input name="website_name" class="form-control" value="AROGYA" type="text">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2">
                                    <div class="img-thumbnail float-right"><img src="assets/img/logo.jpg" alt="" width="40" height="40"></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2">
                                    <div class="settings-image img-thumbnail float-right"><img src="assets/img/logo.jpg" class="img-fluid" width="16" height="16" alt=""></div>
                                </div>
                            </div>
